...
useful to sysadmins.
I put it together myself to centralize the small
...
I __love__ the idea of sysadmins,
...
It makes sense that personal-tools are very personal, but it does mean rejection is almost always the default behavior and that makes me feel bad.

Instead of adding things here consider this repository a small collection of things that I use, and if you want to take some/all of utilities into your own use then please do so.
If not then I would __strongly__ encourage you to consider what tools would make your daily-life more useful and then collect them, __document__ them, and publish them yourself.


In short the value here is the __idea__ of collecting your most commonly used utilities and making them easy to install and update from one central-source.
Not the specific tools themselves.
